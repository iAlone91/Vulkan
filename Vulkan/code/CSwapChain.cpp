...
void SwapChain::createSwapChain()
{
	...
	else
	{
		...
		createInfo.oldSwapchain = m_oldSwapChain == NULL ? VK_NULL_HANDLE : m_oldSwapChain->m_swapChain;
...
VkResult SwapChain::acuireNextImage(uint32_t* imageIndex)
{
	vkWaitForFences(m_device.getDevice(), 1, &m_inFlightFences[m_currentFrame], VK_TRUE, UINT64_MAX);

	VkResult result = vkAcquireNextImageKHR(m_device.getDevice(), m_swapChain, UINT32_MAX, m_imageAvailableSemaphores[m_currentFrame], VK_NULL_HANDLE, imageIndex);
